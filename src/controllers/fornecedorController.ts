...
class fornecedorController {
  public static criarFornecedor = async (
    req: Request,
    res: Response,
  ): Promise<void> => {
    try {
      ...
      const novoFornecedor: iFornecedor = await fornecedorModel.create({
        nomeEmpresa,
        endereco,
      });
  ...
  public static obterFornecedores = async (
    req: Request,
    res: Response,
  ): Promise<void> => {
    try {
  ...
  public static obterFornecedorPorId = async (
  ...
  public static atualizarFornecedor = async (
    ...
    try {
      ...
      const fornecedorAtualizado: iFornecedor | null =
        await fornecedorModel.findByIdAndUpdate(id, dadosAtualizados, {
          new: true,
        });
  ...
  public static excluirFornecedor = async (
    ...
    try {
      ...
      const fornecedorExcluido: iFornecedor | null =
