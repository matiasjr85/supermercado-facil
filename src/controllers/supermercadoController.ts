...
class supermercadoController {
    public static criarSupermercado = async (req: Request, res: Response): Promise<void> => {
        try {
            const {nome, endereco, funcionarios, estoque}: iSupermercado = req.body as iSupermercado;
            ...
            if (funcionarios && funcionarios.length > 0) {
                ...
                supermercado.funcionarios.push(...funcionarioExistentes.map((f) => f._id as mongoose.Types.ObjectId));
            }
    ...
    public static obterSupermercados = async (req: Request, res: Response): Promise<void> => {
        try {
    ...
    public static obterSupermercadoPorId = async (req: Request, res: Response): Promise<void> => {
        try {
            const { id } = req.params;
    ...
    public static atualizarSupermercado = async (req: Request<{ id: string }>, res: Response): Promise<void> => {
        try {
            const { id } = req.params;
    ...
    public static excluirSupermercado = async (req: Request<{ id: string }>, res: Response): Promise<void> => {
        try {
            const { id } = req.params;
    ...
    public static adicionarFuncionario = async (req: Request<{ id: string }>, res: Response): Promise<void> => {
        try {
            const { id } = req.params; 
            ...
            supermercado.funcionarios.push(...funcionariosExistentes.map(f => f._id as mongoose.Types.ObjectId));
